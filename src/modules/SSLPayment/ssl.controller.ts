...
export const PaymentOrder = catchAsync(async (req: Request, res: Response) => {
  ...
  const data = {
    ...
    currency: 'BDT',
    tran_id: tran_id,
    success_url: `http://localhost:4000/api/v1/order/orderPayment/success/${tran_id}`,
    fail_url: `http://localhost:4000/api/v1/order/orderPayment/failed/${tran_id}`,
    cancel_url: `http://localhost:4000/api/v1/order/orderPayment/canceled/${tran_id}`,
    ipn_url: `http://localhost:4000/api/v1/order/orderPayment/ipn/${tran_id}`,
